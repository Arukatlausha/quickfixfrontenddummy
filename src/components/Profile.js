  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-lg">
      ...
      <header className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">Welcome, Amanda</h1>
      ...
      <div className="mt-6 bg-gray-100 p-4 rounded-md">
        <h3 className="text-md font-medium text-gray-800">My email Address</h3>
        <div className="flex items-center mt-2">
          <div className="flex items-center space-x-2">
            <div className="bg-blue-200 p-2 rounded-full">
              <img src="/path/to/email-icon.png" alt="Email" className="w-5 h-5" />
            </div>
            <div>
              <p className="text-sm font-medium text-gray-800">alexarawles@gmail.com</p>
