        ...
        >
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-4">
              Are you looking for Home Services?
            </h2>
            <p className="text-gray-600 mb-6">
              Hire Great Home Service Providers. Fast Home Fix helps you hire
              elite service providers at a moment's notice.
            </p>
        ...
        >
          {[
            ...
            },
            {
              icon: GiWaterDrop,
              text: "Search Service",
              description: "Search the best home services here",
            },
            {
              icon: GiWoodBeam,
              text: "Save and apply",
              description: "Apply or save and start your service",
            },
          ].map((item, index) => (
            <ServiceCard
              key={index}
          ...
          <div className="flex flex-col md:flex-row p-8">
            ...
            <div className="md:w-1/2 mt-8 md:mt-0">
              <h1 className="text-4xl font-bold mb-4">
                Find The Best <span className="text-blue-500">Services</span>{" "}
                Here
              </h1>
              <p className="text-gray-600 mb-8">
                ...
                posuere justo, ultrices interdum sed erat nunc, mattis. Ipsum
                viverra viverra neque adipiscing arcu, quam dictum. Dui mi
                viverra dui, sit accumsan, tincidunt massa. Dui cras magna.
              </p>
          ...
          <div className="px-8 pb-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold">
                The latest home services!{" "}
                <span className="text-blue-500">Recently Posted Works</span>
              </h2>
              ...
              {[
                {
                  ...
                  title: "Home Cleaning",
                  description:
                    "Need a professional logo and brand identity for our jewellery company",
                },
                {
                  icon: GiElectric,
                  title: "Electrician",
                  description:
                    "We need a UI/UX designer with UI/UX skills for our furniture company",
                },
                {
                  icon: GiWaterDrop,
                  title: "Plumber",
                  description:
                    "Need an SEO expert to elevate our company's online presence",
                },
              ].map((service, index) => (
                <motion.div
                  key={index}
